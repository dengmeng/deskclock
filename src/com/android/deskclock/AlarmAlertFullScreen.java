...
public class AlarmAlertFullScreen extends Activity {
    ...
    protected void onCreate(Bundle icicle) {
        ...
        android.util.Log.e("dengmeng", "AlarmAlertFullScreen:onCreate:111");
        ...
        android.util.Log.e("dengmeng", "AlarmAlertFullScreen:onCreate:222");
        ...
        android.util.Log.e("dengmeng", "AlarmAlertFullScreen:onCreate:333");
        ...
        android.util.Log.e("dengmeng", "AlarmAlertFullScreen:onCreate:444");
        ...
        android.util.Log.e("dengmeng", "AlarmAlertFullScreen:onCreate:555");
        if (mBootFromPoweroffAlarm && mIsPoweroffAlarm) {
        	...
        	win.addFlags(WindowManager.LayoutParams.TYPE_SYSTEM_ALERT | WindowManager.LayoutParams.FLAG_HOMEKEY_DISPATCHED);
        	TimerAlert(mAlarm);
        } else {
        	updateLayout();
        }

        android.util.Log.e("dengmeng", "AlarmAlertFullScreen:onCreate:666");
        ...
        android.util.Log.e("dengmeng", "AlarmAlertFullScreen:onCreate:777");
    }
    
    private void killTimerAlert() {
    	stopService(new Intent(Alarms.ALARM_ALERT_ACTION));
        finish();
    }
    
    class TimerAlertClick implements DialogInterface.OnClickListener {
    ...
    class TimerAlertKey implements DialogInterface.OnKeyListener {
    @Override
    ...
    private void TimerAlert(Alarm alarm) {
    	AlertDialog.Builder builder;
    	Object[] arrayOfObject2;
    	Object[] arrayOfObject1;//only min
    	String str;
    	//if (mAlertDialog == null) {
    		builder = new AlertDialog.Builder(this).setTitle(R.string.timer_start_alarm);
    	//}
        if (alarm.hour <= 0) {
        	arrayOfObject1 = new Object[1];
            arrayOfObject1[0] = Integer.valueOf(alarm.minutes);
            str = getString(R.string.timer_message, arrayOfObject1);
        } else {
        	arrayOfObject2 = new Object[2];
            arrayOfObject2[0] = Integer.valueOf(alarm.hour);
            arrayOfObject2[1] = Integer.valueOf(alarm.minutes);
            str = getString(R.string.timer_message_with_hour, arrayOfObject2);
        }
        
        mAlertDialog = builder.setMessage(str).setIconAttribute(android.R.attr.alertDialogIcon).setCancelable(false).setPositiveButton(R.string.timer_got_it, new TimerAlertClick()).create();
        mAlertDialog.setCanceledOnTouchOutside(false);
        mAlertDialog.setOnKeyListener(new TimerAlertKey());
        mAlertDialog.show();
    }
    ...
    protected void onResume() {
        ...
        if ((mAlarm.id >= 0) && Alarms.getAlarm(getContentResolver(), mAlarm.id) == null) {
            Button snooze = (Button) findViewById(R.id.snooze);
	...
	public boolean dispatchKeyEvent(KeyEvent event) {
		...
		OutputLog.alarm("AlarmAlertFullScreen:dispatchKeyEvent:KeyCode="
				+ event.getKeyCode());
	...
	public boolean onKeyDown(int kCode, KeyEvent kEvent) {
		OutputLog.alarm("AlarmAlertFullScreen:onKeyDown:kCode="+kCode);
		switch (kCode) {
			case KeyEvent.KEYCODE_BACK:
				switch (mVolumeBehavior) {
                case 1:
